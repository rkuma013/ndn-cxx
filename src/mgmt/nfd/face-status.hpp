...
private:
  ...
  optional<uint64_t> m_nFragmentationErrors;
  optional<uint64_t> m_nOutOverMtu;
  optional<uint64_t> m_nInLpInvalid;
  optional<uint64_t> m_nReassemblyTimeouts;
  optional<uint64_t> m_nInNetInvalid;
  optional<uint64_t> m_nAcknowledged;
  optional<uint64_t> m_nRetransmitted;
  optional<uint64_t> m_nRetxExhausted;
  optional<uint64_t> m_nCongestionMarked;
};
